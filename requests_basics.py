...
#json_lokace = json.dumps(regiojet_lokace)
...
url_prekladace = "https://api.funtranslations.com/translate/yoda.json?"
parametry = {"text": text}
yoda_1 = requests.get(url=url_prekladace, params=parametry)
